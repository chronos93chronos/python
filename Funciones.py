...
"""
1. Se puede pasar información a las funciones utilizando parámetros. 
...
#_______________________________________________________________
"""
Es importante recordar que primero se especifican los 
argumentos posicionales y después los de palabras clave. 
Es por esa razón que si se intenta ejecutar el siguiente 
código:
"""
def subtra(a, b):
    print(a - b)
...
"""
3. Se puede utilizar la técnica de argumentos con palabras 
clave para asignar valores predefinidos a los argumentos:
"""
